...
<section class="bg-white">
  ...
  <div class="container wow fadeInUp" style="margin-top:10px">
    ...
    <div class="row">
      ...
      <input type="hidden" id="csrfTokenHash" value="<?= $this->security->get_csrf_hash(); ?>">
...
<script>
  $(document).ready(function() {
    ...
    var csrfTokenHash = $('#csrfTokenHash').val();
      ...
      $(document).on('click', '.save-lead', function() {
        ...
        $.ajax({
          ...
          beforeSend: function(xhr) {
            addAuthorizationHeader(xhr); // Add the authorization header
          },
